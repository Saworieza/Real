...
ActiveRecord::Schema.define(version: 20150208054654) do
  ...
  add_index "commercials", ["area_id"], name: "index_commercials_on_area_id"
  ...
  add_index "lands", ["area_id"], name: "index_lands_on_area_id"
  ...
  add_index "rentals", ["area_id"], name: "index_rentals_on_area_id"
