...
class CommercialsControllerTest < ActionController::TestCase
  ...
  test "should create commercial" do
    assert_difference('Commercial.count') do
      post :create, commercial: { amenities: @commercial.amenities, area_id: @commercial.area_id, bedroom: @commercial.bedroom, description: @commercial.description, price: @commercial.price }
    end
  ...
  test "should update commercial" do
    patch :update, id: @commercial, commercial: { amenities: @commercial.amenities, area_id: @commercial.area_id, bedroom: @commercial.bedroom, description: @commercial.description, price: @commercial.price }
    assert_redirected_to commercial_path(assigns(:commercial))
  end
