...
class LandsControllerTest < ActionController::TestCase
  ...
  test "should create land" do
    assert_difference('Land.count') do
      post :create, land: { amenities: @land.amenities, area_id: @land.area_id, description: @land.description, price: @land.price, size: @land.size }
    end
  ...
  test "should update land" do
    patch :update, id: @land, land: { amenities: @land.amenities, area_id: @land.area_id, description: @land.description, price: @land.price, size: @land.size }
    assert_redirected_to land_path(assigns(:land))
  end
