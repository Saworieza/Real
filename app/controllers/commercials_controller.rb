class CommercialsController < ApplicationController
  ...
  # GET /commercials/new
  def new
    @commercial = current_agent.commercials.build
  end
  ...
  def create
    @commercial = current_agent.commercials.build(commercial_params)
  ...
  private
    ...
    def commercial_params
      params.require(:commercial).permit(:price, :bedroom, :amenities, :description, :area_id, :image)
    end
end
